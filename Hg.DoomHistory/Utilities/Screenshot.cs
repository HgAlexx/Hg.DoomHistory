...
namespace Hg.DoomHistory.Utilities
{
    ...
    public class ScreenShots
    {
        ...
        {
            int height = GetSystemMetrics(SystemMetric.SM_CYFRAME) + GetSystemMetrics(SystemMetric.SM_CYCAPTION) +
        ...
        public static Bitmap Take(IntPtr handle)
        {
            Rectangle bounds = GetSize(handle);
